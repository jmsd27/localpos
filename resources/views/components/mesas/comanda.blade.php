...
new #[Layout('layouts.app')] class extends Component
{
    ...
    public function reimprimirTicket(PrintService $printer): void
    {
        ...
        $printer->enqueueSaleTicket(Order::findOrFail($this->orderId));
    }
        ...
        <div class="fixed inset-0 z-50 flex items-center justify-center bg-black/80 p-4">
            <div class="w-full max-w-sm rounded-xl border border-emerald-200 bg-white p-6 text-center">
                ...
                <div class="flex flex-col gap-2">
                    ...
                    <a href="{{ route('ventas.ticket', $order->id) }}" target="_blank" class="rounded-lg border border-gray-300 px-4 py-2 text-sm text-gray-600 hover:bg-white">
                        Ver ticket
                    </a>
