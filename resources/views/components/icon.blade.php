...
<svg {{ $attributes->merge(['class' => 'h-5 w-5', 'viewBox' => '0 0 24 24', 'fill' => 'none', 'stroke' => 'currentColor', 'stroke-width' => '1.5']) }} stroke-linecap="round" stroke-linejoin="round">
    @switch($name)
        ...
        @case('wrench-screwdriver')
            <path d="M14.5 5.5a3.5 3.5 0 0 0 4.6 4.6L21 12l-8.5 8.5-2-2" />
            <path d="M9.5 9.5 4 15a2 2 0 0 0 0 2.8l.2.2A2 2 0 0 0 7 18l5.5-5.5" />
            <path d="m14 14 4.5 4.5a1.8 1.8 0 0 0 2.5-2.5L16.5 11" />
            @break
        @default
